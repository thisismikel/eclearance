...
<p>Hi '.$fullname.',</p>
<p>Your online appointment schedule has been confirmed.  Please click the link below for the details of your appointment schedule.</p>
...
if ($cellno){
					...
					$numbers = $cellno;
					$msg = "Hi ".$fullname.", Your DAR XI online appointment schedule has been confirmed.  Please click the link https://darxi.net/verifyappointment.php?idappointment=".$idappointment; 
